...
# COMMAND ----------
 ...
 df_DimPromotion = df_SpecialOffer.select(
    ...
    translate_to_spanish(F.col('Description')).alias('SpanishPromotionName'),
    translate_to_french(F.col('Description')).alias('FrenchPromotionName'),
    F.col('DiscountPct').alias('DiscountPct'),
    F.col('Type').alias('EnglishPromotionType'),
    translate_to_spanish(F.col('Type')).alias('SpanishPromotionType'),
    translate_to_french(F.col('Type')).alias('FrenchPromotionType'),
    F.col('Category').alias('EnglishPromotionCategory'),
    translate_to_spanish(F.col('Category')).alias('SpanishPromotionCategory'),
    translate_to_french(F.col('Category')).alias('FrenchPromotionCategory'),
